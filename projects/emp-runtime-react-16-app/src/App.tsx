...
const {empRuntime, withReactAdepter} = EmpShareLib
...
const MfApp = withReactAdepter(empRuntime.load('mfHost/App'))
const CountComp = withReactAdepter(empRuntime.load('mfHost/CountComp'), 'CountComp')
...
const ParentComponentAdepter = withReactAdepter(ParentComponent, 'default', React, ReactDOM)
const App = () => {
  return (
    <>
